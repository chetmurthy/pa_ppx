...
declare
  ...
  module Location :
    sig
      declare
        ...
        ;
        declare value pp : Fmt.t t; value show : t → Stdlib.String.t; end;
        [@@@"end"];
      end;
      declare
        type loc α =
  ...
  declare
    ...
    declare
      ...
      value show_constructor_arguments :
        constructor_arguments → Stdlib.String.t;
      ...
      value show_class_type_field_desc :
        class_type_field_desc → Stdlib.String.t;
      ...
      value show_class_type_declaration :
        class_type_declaration → Stdlib.String.t;
