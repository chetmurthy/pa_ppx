...
; value pp_constant : Fmt.t constant; value show_constant : constant → Stdlib.String.t;
[@@@"end"];
type location_stack = list Location.t[@@"deriving_inline" show;]; value pp_location_stack : Fmt.t location_stack; value show_location_stack : location_stack → Stdlib.String.t;
[@@@"end"];
type attribute =
  Parsetree.attribute ==
...
; value pp_attribute : Fmt.t attribute; value show_attribute : attribute → Stdlib.String.t; value pp_extension : Fmt.t extension; value show_extension : extension → Stdlib.String.t; value pp_attributes : Fmt.t attributes; value show_attributes : attributes → Stdlib.String.t; value pp_payload : Fmt.t payload; value show_payload : payload → Stdlib.String.t; value pp_core_type : Fmt.t core_type; value show_core_type : core_type → Stdlib.String.t; value pp_core_type_desc : Fmt.t core_type_desc; value show_core_type_desc : core_type_desc → Stdlib.String.t; value pp_package_type : Fmt.t package_type; value show_package_type : package_type → Stdlib.String.t; value pp_row_field : Fmt.t row_field; value show_row_field : row_field → Stdlib.String.t; value pp_row_field_desc : Fmt.t row_field_desc; value show_row_field_desc : row_field_desc → Stdlib.String.t; value pp_object_field : Fmt.t object_field; value show_object_field : object_field → Stdlib.String.t; value pp_object_field_desc : Fmt.t object_field_desc; value show_object_field_desc : object_field_desc → Stdlib.String.t; value pp_pattern : Fmt.t pattern; value show_pattern : pattern → Stdlib.String.t; value pp_pattern_desc : Fmt.t pattern_desc; value show_pattern_desc : pattern_desc → Stdlib.String.t; value pp_expression : Fmt.t expression; value show_expression : expression → Stdlib.String.t; value pp_expression_desc : Fmt.t expression_desc; value show_expression_desc : expression_desc → Stdlib.String.t; value pp_case : Fmt.t case; value show_case : case → Stdlib.String.t; value pp_letop : Fmt.t letop; value show_letop : letop → Stdlib.String.t; value pp_binding_op : Fmt.t binding_op; value show_binding_op : binding_op → Stdlib.String.t; value pp_value_description : Fmt.t value_description; value show_value_description : value_description → Stdlib.String.t; value pp_type_declaration : Fmt.t type_declaration; value show_type_declaration : type_declaration → Stdlib.String.t; value pp_type_kind : Fmt.t type_kind; value show_type_kind : type_kind → Stdlib.String.t; value pp_label_declaration : Fmt.t label_declaration; value show_label_declaration : label_declaration → Stdlib.String.t; value pp_constructor_declaration : Fmt.t constructor_declaration; value show_constructor_declaration :
  constructor_declaration → Stdlib.String.t; value pp_constructor_arguments : Fmt.t constructor_arguments; value show_constructor_arguments : constructor_arguments → Stdlib.String.t; value pp_type_extension : Fmt.t type_extension; value show_type_extension : type_extension → Stdlib.String.t; value pp_extension_constructor : Fmt.t extension_constructor; value show_extension_constructor : extension_constructor → Stdlib.String.t; value pp_type_exception : Fmt.t type_exception; value show_type_exception : type_exception → Stdlib.String.t; value pp_extension_constructor_kind : Fmt.t extension_constructor_kind; value show_extension_constructor_kind :
  extension_constructor_kind → Stdlib.String.t; value pp_class_type : Fmt.t class_type; value show_class_type : class_type → Stdlib.String.t; value pp_class_type_desc : Fmt.t class_type_desc; value show_class_type_desc : class_type_desc → Stdlib.String.t; value pp_class_signature : Fmt.t class_signature; value show_class_signature : class_signature → Stdlib.String.t; value pp_class_type_field : Fmt.t class_type_field; value show_class_type_field : class_type_field → Stdlib.String.t; value pp_class_type_field_desc : Fmt.t class_type_field_desc; value show_class_type_field_desc : class_type_field_desc → Stdlib.String.t; value pp_class_infos : Fmt.t α → Fmt.t (class_infos α); value show_class_infos : Fmt.t α → class_infos α → Stdlib.String.t; value pp_class_description : Fmt.t class_description; value show_class_description : class_description → Stdlib.String.t; value pp_class_type_declaration : Fmt.t class_type_declaration; value show_class_type_declaration : class_type_declaration → Stdlib.String.t; value pp_class_expr : Fmt.t class_expr; value show_class_expr : class_expr → Stdlib.String.t; value pp_class_expr_desc : Fmt.t class_expr_desc; value show_class_expr_desc : class_expr_desc → Stdlib.String.t; value pp_class_structure : Fmt.t class_structure; value show_class_structure : class_structure → Stdlib.String.t; value pp_class_field : Fmt.t class_field; value show_class_field : class_field → Stdlib.String.t; value pp_class_field_desc : Fmt.t class_field_desc; value show_class_field_desc : class_field_desc → Stdlib.String.t; value pp_class_field_kind : Fmt.t class_field_kind; value show_class_field_kind : class_field_kind → Stdlib.String.t; value pp_class_declaration : Fmt.t class_declaration; value show_class_declaration : class_declaration → Stdlib.String.t; value pp_module_type : Fmt.t module_type; value show_module_type : module_type → Stdlib.String.t; value pp_module_type_desc : Fmt.t module_type_desc; value show_module_type_desc : module_type_desc → Stdlib.String.t; value pp_functor_parameter : Fmt.t functor_parameter; value show_functor_parameter : functor_parameter → Stdlib.String.t; value pp_signature : Fmt.t signature; value show_signature : signature → Stdlib.String.t; value pp_signature_item : Fmt.t signature_item; value show_signature_item : signature_item → Stdlib.String.t; value pp_signature_item_desc : Fmt.t signature_item_desc; value show_signature_item_desc : signature_item_desc → Stdlib.String.t; value pp_module_declaration : Fmt.t module_declaration; value show_module_declaration : module_declaration → Stdlib.String.t; value pp_module_substitution : Fmt.t module_substitution; value show_module_substitution : module_substitution → Stdlib.String.t; value pp_module_type_declaration : Fmt.t module_type_declaration; value show_module_type_declaration :
  module_type_declaration → Stdlib.String.t; value pp_open_infos : Fmt.t α → Fmt.t (open_infos α); value show_open_infos : Fmt.t α → open_infos α → Stdlib.String.t; value pp_open_description : Fmt.t open_description; value show_open_description : open_description → Stdlib.String.t; value pp_open_declaration : Fmt.t open_declaration; value show_open_declaration : open_declaration → Stdlib.String.t; value pp_include_infos : Fmt.t α → Fmt.t (include_infos α); value show_include_infos : Fmt.t α → include_infos α → Stdlib.String.t; value pp_include_description : Fmt.t include_description; value show_include_description : include_description → Stdlib.String.t; value pp_include_declaration : Fmt.t include_declaration; value show_include_declaration : include_declaration → Stdlib.String.t; value pp_with_constraint : Fmt.t with_constraint; value show_with_constraint : with_constraint → Stdlib.String.t; value pp_module_expr : Fmt.t module_expr; value show_module_expr : module_expr → Stdlib.String.t; value pp_module_expr_desc : Fmt.t module_expr_desc; value show_module_expr_desc : module_expr_desc → Stdlib.String.t; value pp_structure : Fmt.t structure; value show_structure : structure → Stdlib.String.t; value pp_structure_item : Fmt.t structure_item; value show_structure_item : structure_item → Stdlib.String.t; value pp_structure_item_desc : Fmt.t structure_item_desc; value show_structure_item_desc : structure_item_desc → Stdlib.String.t; value pp_value_binding : Fmt.t value_binding; value show_value_binding : value_binding → Stdlib.String.t; value pp_module_binding : Fmt.t module_binding; value show_module_binding : module_binding → Stdlib.String.t;
[@@@"end"];
